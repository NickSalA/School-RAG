...
class Log(SQLModel, table=True):
    ...
    resource_type: ResourceType = Field(sa_column=Column("resource_type", PgEnum(ResourceType, name="resource_type"), nullable=False))
    resource_id: str = Field(sa_column=Column("resource_id", String))
    details: Mapped[dict] = mapped_column("details", JSONB)
